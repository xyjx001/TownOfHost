        ...
        public static string GetText()
        {
            ...
            else
            {
                ...
                foreach (var kvp in Options.CustomRoleSpawnChances)
                {
                    ...
                    if (kvp.Key is CustomRoles.Shapeshifter/* or CustomRoles.ShapeMaster*/ or CustomRoles.BountyHunter or CustomRoles.SerialKiller || (kvp.Key == CustomRoles.SPImpostor && SPImpostor.RoleType.GetSelection() == 1)) //シェイプシフター役職の時に追加する詳細設定
                    {
